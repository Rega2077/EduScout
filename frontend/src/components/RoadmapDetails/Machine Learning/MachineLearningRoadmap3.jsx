...
const roadmapSteps = [
  ...
  { title: '4. K-Nearest Neighbors (KNN)', description: 'Understanding KNN for classification and regression tasks.', difficulty: 'Medium', link: 'https://www.ibm.com/topics/knn#:~:text=The%20k%2Dnearest%20neighbors%20(KNN,of%20an%20individual%20data%20point.' },
  { title: '5. Decision Trees and Random Forests', description: 'Apply decision trees and random forests for classification.', difficulty: 'Medium', link: 'https://www.analyticsvidhya.com/blog/2020/05/decision-tree-vs-random-forest-algorithm/' },
  { title: '6. Naive Bayes Classifier', description: 'Understanding and implementing Naive Bayes for text classification.', difficulty: 'Medium', link: 'https://www.geeksforgeeks.org/naive-bayes-classifiers/' },
  { title: '7. Ensemble Methods (Bagging & Boosting)', description: 'Learn ensemble techniques for improving ML models.', difficulty: 'Medium', link: 'https://www.ibm.com/topics/ensemble-learning#:~:text=Ensemble%20learning%20is%20a%20machine,than%20a%20single%20model%20alone.' },
  ...
  { title: '9. Neural Networks Fundamentals', description: 'Learn basics of neural networks and backpropagation.', difficulty: 'Hard', link: 'https://www.geeksforgeeks.org/neural-networks-a-beginners-guide/' },
  ...
  { title: '11. Recurrent Neural Networks (RNN)', description: 'Learn how RNNs are used for sequential data.', difficulty: 'Hard', link: 'https://www.geeksforgeeks.org/introduction-to-recurrent-neural-network/' },
  ...
  { title: '15. Generative Adversarial Networks (GANs)', description: 'Explore GANs for generative modeling.', difficulty: 'Hard', link: 'https://www.geeksforgeeks.org/generative-adversarial-network-gan/' },
  { title: '16. Reinforcement Learning', description: 'Dive into reinforcement learning and Q-learning.', difficulty: 'Hard', link: 'https://www.geeksforgeeks.org/what-is-reinforcement-learning/' },
  ...
  { title: '18. Time Series Forecasting', description: 'Apply machine learning models for time series data.', difficulty: 'Hard', link: 'https://www.influxdata.com/time-series-forecasting-methods/#:~:text=Time%20series%20forecasting%20is%20a,Astronomy' },
